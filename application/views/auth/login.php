...
<html lang='en'>
  ...
  <head>
    ...
    <title>ACCSEGERAN Codeigniter</title>
    <!-- CSS  -->
  ...
  <body>
    <nav class='light-blue lighten-1' role='navigation'>
      <div class='nav-wrapper container'><a id='logo-container' href='<?php echo base_url(); ?>' class='brand-logo'>ACCSEGERAN Codeigniter</a></div>
    </nav>
    ...
    <footer class='page-footer white'>
      <div class='footer-copyright  blue darken-3'>
        <div class='container center-align'>
          Copyright &copy; <a class='white-text text-lighten-3' href='https://www.accsegeran.com'>ACCSEGERAN Interactive </a>
        </div>
      </div>
    </footer>
