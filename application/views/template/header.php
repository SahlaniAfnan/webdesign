...
<html lang="en">
  <head>
    ...
    <title><?php echo $pageTitle; ?> | ACCSEGERAN Admin</title>
    ...
    <link href="<?php echo base_url('asset/css/sahlan.css'); ?>" type="text/css" rel="stylesheet" media="screen,projection"/>
  </head>
  <body>
    <header>
      <nav class="light-blue lighten-1 navbar-fixed" role="navigation">
        <div class="nav-wrapper container">
          <a id="logo-container" href="<?php echo base_url('#'); ?>" class="brand-logo center">
            <img src="<?php echo base_url('asset/images/logo.png'); ?>" alt="accsegeran Logo">
          </a>
